...
{
	public class ObservableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, PlatformSupport.Collections.Specialized.INotifyCollectionChanged, INotifyPropertyChanged
	{
		...
		public event PlatformSupport.Collections.Specialized.NotifyCollectionChangedEventHandler CollectionChanged;
